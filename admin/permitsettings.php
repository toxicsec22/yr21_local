...
$list='PermitSettings';
$table='admin_1permittype'; $txnid='PID'; $txnidname='PID';
...
$list='FrequencyList';
$table='admin_0permitfrequency'; $txnid='FID'; $txnidname='FID'; $width='30%';
...
$list='StatusList';
$table='admin_0permitstatus'; $txnid='StatusID'; $txnidname='StatusID'; $width='30%';
$sql='SELECT * FROM `'.$table.'` ';
