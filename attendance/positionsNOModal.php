...
$listssql=array(
    ...
    array('sql'=>'SELECT JobLevelID, JobLevel FROM `attend_0joblevels` jl  ORDER BY jc.JobLevelID,JobLevelID', 'listvalue'=>'JobLevel', 'label'=>'JobLevelID','listname'=>'joblevels')
);
