...
if (in_array($which,array('AssignUtilityBill','ReceiveBill','EditSpecificsAssignUtilityBill','MonitorBills','SendToCV','AssignmentHistory'))){
   ...
   $columnnameslist=array('BillerName','BillType','SubscriberName', 'AccountNo','ShortAcctID', 'TelMobileNo', 'MRF','AddOns','PlanDescription', 'Assignee', 'ExpenseOf', 'DeclaredforCompany','CutOffDay','DueDay','DateAssigned','EndOfContract','Remarks','Active?','Timestamp');
