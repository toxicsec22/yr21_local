...
if (allowedToOpen(6269,'1rtc')) {
        if ($edit==2){ //called at Edit per row
            if(allowedToOpen(62691,'1rtc')) {
                    ...
                    $columnnames=array('CanvassID','CanvassDate', 'ForBranch','Category','ItemCode','Description','UnitCost','SellingPrice','QuotedPrice','PONo','CanvassRequestedByNo','CanvassRequestTS','CanvassedByNo','SCReplyTS','SupplierNo','Go','Downpayment','Ordered?','GoByNo','GoTimeStamp','DPAmtByNo','DPAmtTimeStamp','OrderedByNo','OrderedTimeStamp','Delivered?','DeliveredByNo','DeliveryEnteredByNo','ForClientName','DeliveryEnteredTS','Sold?','InvNo','SoldEntryByNo','SoldEntryTS');
                    $columnstoedit=array('CanvassDate', 'ForBranch','ForClientName','Category','ItemCode','Description','UnitCost','SellingPrice','QuotedPrice','PONo','SupplierNo','Go','Ordered?','Delivered?','DeliveredByNo','Sold?','InvNo');
                    $hiddencolumns=array('CanvassID','CanvassRequestedByNo','CanvassRequestTS','CanvassedByNo','SCReplyTS','GoByNo','GoTimeStamp','DPAmtByNo','DPAmtTimeStamp','OrderedByNo','OrderedTimeStamp','DeliveryEnteredByNo','DeliveryEnteredTS','SoldEntryByNo','SoldEntryTS');
                ...
                $hiddencolumns=array('PONo','Ordered?','Delivered?','DeliveredByNo','CanvassRequestedByNo','CanvassRequestTS','CanvassedByNo','SCReplyTS','GoByNo','GoTimeStamp','OrderedByNo','OrderedTimeStamp','DeliveryEnteredByNo','DeliveryEnteredTS','SoldEntryByNo','SoldEntryTS');
            } elseif (allowedToOpen(62693,'1rtc')){
                $columnstoedit=array('ForClientName','Go','Sold?');
                $hiddencolumns=array('CanvassID','CanvassDate', 'ForBranch','Category','ItemCode','Description','UnitCost','SellingPrice','QuotedPrice','PONo','CanvassRequestedByNo','CanvassRequestTS','CanvassedByNo','SCReplyTS','SupplierNo','Ordered?','GoByNo','GoTimeStamp','DPAmtByNo','DPAmtTimeStamp','OrderedByNo','OrderedTimeStamp','Delivered?','DeliveredByNo','DeliveryEnteredByNo','DeliveryEnteredTS','InvNo','SoldEntryByNo','SoldEntryTS');
            } elseif (allowedToOpen(62694,'1rtc')){   
                $columnstoedit=array('Delivered?','DeliveredByNo');
                $hiddencolumns=array('CanvassID','CanvassDate', 'ForBranch','Category','ItemCode','Description','UnitCost','SellingPrice','QuotedPrice','PONo','CanvassRequestedByNo','CanvassRequestTS','CanvassedByNo','SCReplyTS','SupplierNo','Go','Ordered?','GoByNo','GoTimeStamp','DPAmtByNo','DPAmtTimeStamp','OrderedByNo','OrderedTimeStamp','DeliveryEnteredByNo','ForClientName','DeliveryEnteredTS','Sold?','InvNo','SoldEntryByNo','SoldEntryTS');
